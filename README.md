...
Trusted maintainers can route a manual Linux CI run to the organization's Nexus runner pool when `NEXUS_RUNS_ON_LINUX` contains a reviewed JSON selector such as `["self-hosted","Linux","X64","nexus-run"]`:
